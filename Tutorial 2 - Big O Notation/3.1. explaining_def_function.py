...
#For if you do not know how many (positional) arguments that will be passed into your function, add a '*'
#before the parameter name in the function definition. (hence in main code can put as many arguments as you
#want) The function will then accept a tuple of arguments can access each element accordingly (by index)
...
#(BTW the way the order of the keyword arguments does not matter in the self-made function and in main code,
#but the parameter name must be the same in the self-made function and main code as it uses the exact key 
#name provided in the main code to run the code in the self-made function)
...
#put as many key-value pairs as you want) The function will then accept a dictionary of arguments,
#and can access the items accordingly (by key)
...
#Python also accepts recursion, which means a defined function can call itself within the function. (More
#in the Data Structures and Algorithms folder later)

#Another side note:
#Whats the difference between positional arguments (args) and keyword arguments (kwargs)?
#They are almost the same, with the main difference between positional arguments (args) and keyword arguments 
#(kwargs) lies in how they are passed and associated with parameters in function calls. Positional arguments 
#rely on their positions in the function call, while keyword arguments explicitly specify the parameter names 
#they correspond to. Both types of arguments provide different ways of calling functions, offering flexibility
